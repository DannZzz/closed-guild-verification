...
export const MONGO = processOr("MONGO", "mongodb+srv://DannTest:099075020@botdiscord.hkvvx.mongodb.net/guildVerify");
export const CLIENT_ID = processOr("CLIENT_ID", "983361220885225472");
export const DEV_ID = "382906068319076372";
export const PRIVATE_SERVER_DEV = "983420110729535548";
